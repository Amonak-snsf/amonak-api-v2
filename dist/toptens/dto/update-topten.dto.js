...
class UpdateToptenDto extends (0, swagger_1.PartialType)((0, swagger_1.OmitType)(create_topten_dto_1.CreateToptenDto, ['files', 'name', 'productNature', 'company', 'duration', 'user', 'price', 'webSites', 'content'])) {
}
__decorate([
