...
export declare const allDistinct: (model: Model<any>, field: string, filter: Record<string, any>, sort?: Object, limit?: Number, populate?: string, populateFields?: String | String[]) => Promise<Omit<any, never>[]>;
