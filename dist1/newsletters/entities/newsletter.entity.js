...
const newsletter_type_dto = require("./newsletter-type.dto");
let Newsletter = class Newsletter extends default_model.DefaultModel {
};
__decorate([
    (0, mongoose.Prop)({ required: true, type: String, trim: true, lowercase: true }),
...
__decorate([
    (0, mongoose.Prop)({ required: true, type: String, trim: true, default: newsletter_type_dto.ContactType.newsletter }),
    __metadata("design:type", String)
...
exports.NewsletterSchema = mongoose.SchemaFactory.createForClass(Newsletter);
