...
const status_sellerInfo = require("../dto/status-seller-info");
const default_model = require("../../utils/default-model");
let SellerInfo = class SellerInfo extends default_model.DefaultModel {
};
__decorate([
...
__decorate([
    (0, mongoose.Prop)({ required: true, enum: status_sellerInfo.Status }),
...
exports.SellerInfoSchema = mongoose.SchemaFactory.createForClass(SellerInfo);
