...
const chats_service = require("./chats.service");
const create_chat_dto = require("./dto/create-chat.dto");
const update_chat_dto = require("./dto/update-chat.dto");
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_chat_dto.CreateChatDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_chat_dto.UpdateChatDto]),
    __metadata("design:returntype", void 0)
...
ChatsController = __decorate([
    (0, swagger.ApiTags)('chats'),
    (0, swagger.ApiHeader)({
        name: 'lang',
        description: 'language',
    }),
    (0, common.Controller)('chats'),
    __metadata("design:paramtypes", [chats_service.ChatsService])
], ChatsController);
