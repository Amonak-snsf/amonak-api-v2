...
const cart_status_dto = require("./cart-status.dto");
class CreateCartDto {
}
__decorate([
...
__decorate([
    (0, swagger.ApiProperty)({ required: true, type: Number, default: 1 }),
    __metadata("design:type", Number)
], CreateCartDto.prototype, "amount", void 0);
__decorate([
    (0, swagger.ApiProperty)({ required: false, type: Number, default: 0 }),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger.ApiProperty)({ required: false, type: String, default: cart_status_dto.CartStatus.unpaid }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger.ApiProperty)({ required: false, type: Boolean, default: false }),
    __metadata("design:type", Boolean)
