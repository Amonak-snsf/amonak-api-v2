...
let Invoice = class Invoice extends cart_entity.Cart {
};
__decorate([
...
__decorate([
    (0, mongoose.Prop)({ required: false, type: String, default: '' }),
...
__decorate([
    (0, mongoose.Prop)({ required: false, type: Date, default: '' }),
...
__decorate([
    (0, mongoose.Prop)({ required: true, type: String }),
    __metadata("design:type", String)
...
exports.InvoiceSchema = mongoose.SchemaFactory.createForClass(Invoice);
