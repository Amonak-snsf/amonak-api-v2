...
const comment_entity = require("../../comments/entities/comment.entity");
const mongoose = require("mongoose");
const default_model = require("../../utils/default-model");
let CommentLike = class CommentLike extends default_model.DefaultModel {
};
__decorate([
    (0, mongoose.Prop)({ required: false, type: mongoose.Schema.Types.ObjectId, ref: 'Comment' }),
    __metadata("design:type", comment_entity.Comment)
...
exports.CommentLikeSchema = mongoose.SchemaFactory.createForClass(CommentLike);
